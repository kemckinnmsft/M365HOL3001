...
2. Configure Salesforce in Azure AD
    ...
    1. In Salesforce, go to **Setup**, search for **My Domain** and
        register a new domain. You can use the beginning part of **<TenantName>**.

        ![MyDomain.png](https://github.com/kemckinnmsft/M365HOL3001/blob/master/Media/MyDomain.png)

    5. Save **full Salesforce domain name**, including **https://** for the
        next step, e.g., <https://ems123456-dev-ed.salesforce.com>

		![sfdomain.png](https://github.com/kemckinnmsft/M365HOL3001/blob/master/Media/sfdomain.png)
...
1.	Login into ContosoDC by typing Ctrl-Alt-Delete and using the credentials below:  
...
4.	To generate an additional risky sign-in, open a new Tor window and log-in to **https://portal.office.com++ with **AliceA@<TenantName>**
	1.	Notice how you are prompted for MFA due to the risky sign-ins policy
...
1.Insert the saved **Client ID** and **key** for the values of **ClientID** and **ClientSecret** variable and click **Run**.
	...
	$tenantdomain   = "<TenantName>"    # For example, contoso.onmicrosoft.com
